package com.ej.zemanimhamitzriyim.notifications;
...
import com.ej.zemanimhamitzriyim.activities.MainFragmentManager;
...
public class NextZmanCountdownNotification extends Service {
    ...
    private void updateNotification(ZmanListEntry zman) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            ...
            } catch (SecurityException | ForegroundServiceStartNotAllowedException exception) {
